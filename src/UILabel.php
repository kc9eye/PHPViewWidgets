<?php
/**
 * Copyright (C) 2012 Paul W. Lane <kc9eye@gmail.com>
 *
...
namespace kc9eye\PHPViewWidgets\Widgets\Forms
{
    ...
    /**
     * Creates a form label element widget
     */
    class UILabel extends UIWidget
    {
         ...
         * This widget accepts the follwoing optoins: label,for,class,style,id,other
         */
