...
namespace kc9eye\PHPViewWidgets\Widgets {
    //class: PHPViewWidgets\Widgets\UILi
    //This class represents an list item.
    //
    //topic: Extends
    ...
    //string - An optional string to add to as the item.
    /**
     * Create a ui element widget container
     */
    class UILi extends UIContainer {
        /**
         * Class constructor
         * 
         * @param kc9eye\PHPViewWidgets\Widgets\Options $opts an optional Options class containing the options for this widget.
         * This widget accepts the following options: id,class,style,other,string
         * @param kc9eye\PHPViewWidgets\Interfaces\Widget[] $widgets an array of widgets to place inside this widgets container
         */
        ...
        /**
         * Returns this widget and all contained widgets as a string
         * 
         * @return String
         */
