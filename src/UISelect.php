...
namespace kc9eye\PHPViewWidgets\Widgets\Forms {
    ...
    /**
     * Creates a select element widget container
     */
    class UISelect extends UIContainer {
        /**
         * Class constructor
         * 
         * @param kc9eye\PHPViewWigets\Widgets\Options $opts an optional Options class containing the options for this widget.
         * This widget accepts the following options: class,name,id,mulitple,other
         * @param kc9eye\PHPViewWidgets\Interfaces\Widget $widgets an array of widgets to add to this widgets container (usually UIOption widgets).
         */
        ...
        /**
         * Returns the widget and its container as a string
         * 
         * @return String
         */
