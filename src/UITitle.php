...
namespace kc9eye\PHPViewWidgets\Widgets {
    /**
     * Creates a title element widget
     */
    class UITitle extends UIWidget {
        /**
         * Class construtor
         * 
         * @param kc9eye\PHPViewWidgets\Widgets\Options $opts an optional Options class containing options for this widget.
         * This widget accepts the following options: title
         */
