...
namespace PHPViewWidgets\Widgets {
    //class: PHPViewWidgets\Widgets\UITh
    //This class represents a th widget.
    //
    //topic: Extends
    ...
    //other - an optional string to add as attribute
    //string - an optional string to add into the th widget
    class UITh extends UIContainer {
